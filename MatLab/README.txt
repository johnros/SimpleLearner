...
After extracting all files into the current directory, type the following in a Matlab console. The test classification error using all layers and best lambda should be on the order of 5% (the exact values will vary depending on the output of the stochastic optimization procedure). 
